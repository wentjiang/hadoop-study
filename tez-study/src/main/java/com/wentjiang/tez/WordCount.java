...
public class WordCount extends TezExampleBase {
    ...
    /*
     * Example code to write a processor in Tez.编写tez中的处理器
     * Processors typically apply the main application logic to the data.
     * TokenProcessor tokenizes the input data.输入数据
     * It uses an input that provide a Key-Value reader and writes
     * output to a Key-Value writer. The processor inherits from SimpleProcessor 继承于SimpleProcessor
